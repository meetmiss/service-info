    ...
    <div class="table">
      ...
      >
        ...
        <el-table-column align="center" label="服务对象">
          ...
          >
            <template slot-scope="scope">
              <span>{{ scope.row.D_SERVICE_OBJ_NAME }}</span>
            </template>
          </el-table-column>
          <el-table-column
            align="center"
          ...
          >
            <template slot-scope="scope">
              <span>{{ scope.row.D_SERVICE_OBJ_TYPE }}</span>
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column align="center" label="服务内容">
          ...
          >
            <template slot-scope="scope">
              <span>{{ scope.row.D_DATA_TYPE | cotegoryChange }}</span>
            </template>
          </el-table-column>
          <el-table-column
            align="center"
          ...
          >
            <template slot-scope="scope">
              <span>{{ scope.row.D_DATA_CONTENT }}</span>
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column align="center" label="资料开始时间" min-width="170">
          <template slot-scope="scope">
            <span>{{ scope.row.D_DATA_START_DATE | datePickerChange }}</span>
          </template>
        </el-table-column>
        <el-table-column align="center" label="资料结束时间" min-width="170">
          <template slot-scope="scope">
            <span>{{ scope.row.D_DATA_END_DATE | datePickerChange }}</span>
          </template>
        </el-table-column>
        <el-table-column
          align="center"
        ...
        <el-table-column align="center" label="合资单位信息">
          <el-table-column align="center" label="合资单位名称" min-width="180">
            <template slot-scope="scope">
              <span>{{ scope.row.JOINT_DEPART_NAME }}</span>
            </template>
          </el-table-column>
          <el-table-column align="center" label="合资单位性质" min-width="170">
            <template slot-scope="scope">
              <span>{{ scope.row.JOINT_DEPART_NATURE }}</span>
            </template>
          </el-table-column>
          <el-table-column
            align="center"
          ...
          >
            <template slot-scope="scope">
              <span>{{ scope.row.JOINT_PROPORTION }}</span>
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column
        ...
        >
          <template slot-scope="scope">
            <span>{{ scope.row.DATA_SERVICE_CONDITION }}</span>
          </template>
        </el-table-column>
        <el-table-column
          align="center"
...
import { queryLoad, addInsert, updateData, deleteData, login } from "@/api";
export default {
  name: "detail",
